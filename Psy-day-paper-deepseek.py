...
SCREENING_POLICY_VERSION = "2026-09-07-human-psychology-neuroscience-v3"
...
def _build_prompt(title, summary, journal="", journal_metrics=None):
    ...
    return f"""你是一名严谨的心理学学术编辑。请根据标题和摘要，判断论文是否与三条追踪主线高度相关，值得进入每周 20 至 40 篇的前沿文献周报。
...
【共同纳入前提】
仅收录以人为研究对象、或主要讨论人类研究的综述和方法学研究，且处于心理学、健康心理学或神经科学语境。动物实验、细胞实验、体外实验，以及单纯神经、生物或生理机制分析一律排除。泛方法论、泛综述、泛心理干预和泛数字健康研究，只要与三条主线存在明确关联且主要讨论人类研究，可以收录。
...
【心理健康与数字心理干预特别规则】
必须同时满足：（1）心理、情绪、行为、主观体验或心理生理指标是主要结局或核心目标；（2）研究实际聚焦明确的干预、练习、治疗、试验、随机试验、方案或项目设计。无需特意限定数字递送。特别关注正念、呼吸训练、冥想、放松训练、HRV 生物反馈等身心取向干预。笼统的长程 CBT、ACT 治疗若没有 EMA/ESM、EMI/JITAI、微干预、数字递送、心脑或心理生理联系，通常排除。
