...
【生态瞬时干预特别规则】
必须直接研究 EMA/ESM、密集纵向测量、EMI、JITAI、微随机试验、数字表型或被动感知中的至少一种。对于 EMA/ESM 或日记法评估研究，若仅是简单自评问卷且不涉及干预，也不结合 ECG、PPG、HRV、EDA/皮电、呼吸、活动记录、可穿戴或其他客观生理/传感指标，一律排除。一般移动健康、可穿戴设备、应用程序或泛自适应治疗研究，如未构成上述设计、方法或主要研究结局，一律排除。

【心理健康与数字心理干预特别规则】
必须以心理健康、精神障碍、情绪问题或情绪调节为直接研究对象，并同时明确包含数字/移动递送方式及干预、治疗、试验或方案等信号。泛心理健康、一般正念、泛幸福感，或只在背景中提及数字技术的研究一律排除。
...
“重点推荐”仅用于以下情形：跨越两条及以上主线；直接研究心脑指标与心理健康数字干预交叉；或明确将 EMA/ESM、EMI/JITAI 与 ECG、PPG、HRV、EDA/皮电、呼吸、活动记录或其他客观生理/传感指标结合。否则标为“常规收录”。"""
