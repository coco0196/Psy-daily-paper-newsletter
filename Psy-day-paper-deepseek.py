...
“重点推荐”与“是否收录”完全独立，仅用于以下任一情形：真实跨越两条及以上主线；明确将 EMA/ESM、EMI/JITAI 与 ECG、PPG、HRV等客观生理数据紧密结合；心脑指标被直接用于身心干预；同时测量 EEG 与 ECG；顶级期刊，或具有显著方法学/临床价值的研究。其他直接相关论文一律标为“常规收录”。"""
