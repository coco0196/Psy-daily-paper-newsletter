...
def _build_prompt(title, summary, journal="", journal_metrics=None):
    ...
    return f"""你是一名严谨的心理学学术编辑。请根据标题和摘要，判断论文是否与三条追踪主线具有明确、直接的连接，值得进入每周 20 至 40 篇的前沿核心文献周报。
...
【直接性阈值】
只有满足下列任一条件才收录：（1）论文的主要研究问题、核心方法或主要结局直接属于心脑轴、EMA/ESM、EMI/JITAI 或心理微干预3个领域；（2）论文是以这些主题为核心对象的研究综述或方法综述。仅在背景中提及、仅为次要测量、泛相邻主题、泛方法、泛心理干预、泛数字健康、部分相关、无法确认或不十分相关时，一律排除。
...
【生态瞬时干预特别规则】
必须直接研究 EMA/ESM、密集纵向测量、EMI、JITAI、微随机试验、数字表型或被动感知中的至少一种。对于 EMA/ESM 或日记法评估研究，若仅是简单自评问卷、没有干预练习、且不结合 ECG、PPG、HRV、EDA/皮电、呼吸、活动记录、可穿戴或其他客观生理/传感指标，一律排除；有干预练习（涉及EMI），或有客观传感器/生理数据，则可以收录。仅因出现 ECG、PPG、HRV、EEG、可穿戴或 App，不能标注为本主题；它们只有采用上述研究方法时才相关。若这些指标用于心理生理、心脑交互、迷走神经或自主神经研究，应更可能为“心脑轴”领域。

【心理微干预特别规则】
必须同时满足：（1）心理、情绪、行为、主观体验或心理生理指标是主要结局或核心目标；（2）研究实际聚焦明确的微干预、简短干预、自助练习、数字干预或身心干预。特别关注正念、呼吸训练、冥想、放松训练、HRV 生物反馈等身心取向干预。笼统的长程 CBT、ACT 等心理治疗若没有 EMA/ESM、EMI/JITAI、微干预、数字递送、心脑或心理生理联系，一律排除。
