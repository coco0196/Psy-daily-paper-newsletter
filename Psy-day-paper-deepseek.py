...
【严格收录阈值】
只有当至少一条追踪主线是论文的主要研究问题、核心方法或主要结局，且这种关系能从标题和摘要明确确认时，才收录。研究只是背景提及、次要测量、宽泛相邻主题、部分相关、无法判断或不十分相关时，一律排除。普通直接相关论文可以收录，但“不是重点推荐”绝不能成为排除理由。

对于综述、系统综述、meta 分析或方法学综述，也必须以至少一条主线为综合对象或核心方法；泛心理健康、泛数字健康或泛生理学综述不收录。
