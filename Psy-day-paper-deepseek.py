...
SCREENING_POLICY_VERSION = "2026-09-06-high-precision-direct-relevance-v2"
...
def _build_prompt(title, summary, journal="", journal_metrics=None):
    ...
    return f"""你是一名严谨的心理学学术编辑。请根据标题和摘要，判断论文是否与三条追踪主线高度相关，值得进入追踪文献周报。

【三条追踪主线领域】
1. 心脑轴：心脑交互/耦合、神经内脏整合，以及与心理健康相关的 HRV、迷走神经和自主神经系统研究。
2. 生态瞬时干预：EMA/ESM、密集纵向测量、EMI、JITAI、微随机试验、数字表型和实时个体化干预。
3. 心理健康与数字心理干预：以心理、情绪、行为、主观体验或心理生理指标为结局的干预研究，包括数字、移动、自助、心理治疗和身心干预。

所有领域必须处于心理学语境。直接对应主线的综述、系统综述、meta 分析和方法学综述可以收录。

【心脑轴特别规则】
HRV、迷走神经、自主神经系统或副交感神经相关研究，只有在明确涉及心理健康、精神障碍、情绪、压力、认知、行为、心理干预、日常生活动态测量或神经科学问题时才相关。纯心血管疾病、手术、药物、解剖、生理机制、生化机制、动物/细胞研究及无心理行为意义的研究一律排除。
...
【心理健康与数字心理干预特别规则】
必须同时满足：（1）心理、情绪、行为、主观体验或心理生理指标是主要结局或核心目标；（2）研究实际关注明确的干预、练习、治疗、试验、随机试验、方案或项目设计。特别关注正念、呼吸训练、冥想、放松训练、HRV 生物反馈等身心取向干预。笼统的长程 CBT、ACT 治疗若没有微干预、身心干预、数字递送或与三条主线的直接联系，通常排除。
